function KeyboardInteraction_PaperAirplane
%{ 
Demo for keyboard control. Borrowed from my airplane sim examples.
...
fig.Position = [200 200 1200 800]; %Change figure position and size
